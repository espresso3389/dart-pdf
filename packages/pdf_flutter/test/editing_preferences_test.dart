...
void main() {
  group('PdfEditingPreferences', () {
    ...
    test('a value set while loading is not clobbered by stored data',
        () async {
      SharedPreferences.setMockInitialValues(
          {'pdf_flutter.editing.strokeWidth': 9.0});
    ...
    test('a new controller adopts the stored preferences', () async {
      SharedPreferences.setMockInitialValues({
        'pdf_flutter.editing.color': 0xFF00A040,
        'pdf_flutter.editing.strokeWidth': 6.0,
        'pdf_flutter.editing.fontSize': 22.0,
        'pdf_flutter.editing.opacity': 0.4,
        'pdf_flutter.editing.fingerDrawsInk': false,
      });
